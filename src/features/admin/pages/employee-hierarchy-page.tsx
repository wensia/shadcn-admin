/**
 * 员工汇报层级页面
 * 展示员工上下级汇报关系（manager → subordinates）
 *
 * 注：与 /admin/organization-tree 不同 —
 * 组织架构树展示 Region→District→Area→Campus→Department 的组织单位层级，
 * 本页展示的是员工个人之间的上下级汇报关系。
 */
  ...
  return (
    ...
    <Main>
      <div className="mb-2 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">员工汇报层级</h2>
          <Text type="tertiary">
            查看员工的上下级汇报关系（manager → subordinates）
          </Text>
        </div>
        <Button
          theme="outline"
